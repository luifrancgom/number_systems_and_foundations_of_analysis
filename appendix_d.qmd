...
1. Prove that any infinite set $B$ contains a denumerable set. (Hint: This requieres the Axiom of Choice), which provides a function $\psi$ such that $\psi(D) \in D$ for all non empty subsets $D$ of $B$. Define by the Iteration Theorem **Pending reference Chapter 2**, a function $\theta: \mathbb{P} \xrightarrow[]{1-1} B$ and $\mathscr{R}(\theta)$ is a denumerable subset of $B$.
