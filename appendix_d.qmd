...
1. Using @thm-finite-set b we can use its contraposition and @def-infinite-set. That is, $D$ is infinite then $B$ is infinite or $D \not \subseteq B$. But $D \subseteq B$ so it must be the case that $B$ is infinite. 

2. Using @thm-finite-set c we can use its contraposition and @def-infinite-set. That is, $D$ is infinite then $B$ is infinite or $D \not \leq B$. But $D \leq B$ so it must be the case that $B$ is infinite.
