...
In most mathematical theories, equality is taken as a primitive undefined relation. In order to use the equality relation it suffices to postulate the following properties:
