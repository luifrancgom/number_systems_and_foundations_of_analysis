...
Consider any peano system $(\mathbb{P}, S, 1)$. Let $W$ be an arbitrary set, let $c$ be a fixed element of $W$, and let $g$ be a singulary operation on $W$, that is $g: W \longrightarrow W$. Then, there is a unique function $F: P \longrightarrow W$ such that:
